...
/// <summary>
/// Optional standalone home for the shared <see cref="NotesView"/>. Notes normally lives as a panel
...
public partial class NotesWindow : Window
{
    ...
    private const string BoundsKey = "NotesBounds";
    ...
    private NotesView View => ((App)Application.Current).NotesView;
    ...
    public NotesWindow()
    {
        ...
        Loaded += (_, _) =>
        {
            ((App)Application.Current).AttachNotesTo(NotesHost);
            View.AnimateIn();
            AnimateWindowIn();
        };
    }
    ...
    private void Dock_Click(object sender, RoutedEventArgs e) => ((App)Application.Current).DockNotes();
    ...
    protected override void OnClosing(CancelEventArgs e)
    {
        ...
        ((App)Application.Current).OnNotesWindowClosed();
    }
