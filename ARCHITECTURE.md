...
| 2026-08-05 | Released v2.1.0 — a minor bump, because prompt sets add a feature and take nothing away. Bumped `<Version>` in the csproj, moved the CHANGELOG entry out of Unreleased, and recorded the one fix that shipped with it (a search filtering the open note out of the list dropped the last 600 ms of typing, for ordinary notes too). |
